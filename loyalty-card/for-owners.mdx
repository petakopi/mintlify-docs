...
Display a QR code at your counter so customers can scan to get the loyalty card. See the [QR template page](/loyalty-card/qr-template) to pick a design and request a print-ready file for your shop.

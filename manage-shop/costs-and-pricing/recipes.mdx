...
## Market price (optional, recommended)

Each recipe also has a **Market price (RM)** field — the actual price you charge on your menu today. It's optional, but filling it in unlocks two things:

- The [Calculator](/manage-shop/costs-and-pricing/calculator)'s **Unit economics check** card, which compares your real market prices against your fixed costs and tells you whether the plan breaks even at planned volume.
- The recipe-derived target line on [Pulse's revenue burn chart](/manage-shop/pulse/summary#revenue-burn-chart). With market prices set, the target reflects what you actually charge — not just what the Calculator suggests.

If you leave it blank, nothing breaks; the Calculator's suggested price is used as the fallback for any recipe without a market price set.

<Tip>Fill in market prices for your top sellers first. The Unit economics check averages across whatever recipes have one set — so even a handful of mapped prices is enough for a useful read.</Tip>
...
## Minimal and Full views

The Recipes index has a **Minimal / Full** toggle at the top right, next to the search box.

- **Minimal** (the default) shows just the recipe names — a clean list for finding and editing.
- **Full** adds six columns: **COGS**, **Target food cost**, **Quick price**, **Sold this month**, **Revenue**, **Gross margin**. Every column header sorts, so you can rank by margin or by what's selling.

<Warning>Everything the numbers below describe lives in **Full** view. If you've just mapped your Loyverse items and the index looks unchanged, you're in Minimal — flip the toggle. Your choice is remembered in that browser.</Warning>

The search box filters by recipe name and works in both views.

## Per-recipe sales (after Loyverse linkage)

If you map Loyverse variants to recipes (see [Loyverse Items](/manage-shop/costs-and-pricing/loyverse-items)), three of the Full-view columns come alive: **Sold this month**, **Revenue**, **Gross margin**.
